...
podgladModuleServer <- function(id, input, output, session, con) {
  
  output$podgladView <- renderDT({
  ...
  observeEvent(input$podgladView_rows_selected, {
    selected_row <- input$podgladView_rows_selected
